...
## 2024-05-25 — Global Accessibility Baseline in Tailwind CSS
...
**Action:** Implement a global `:focus-visible` outline for all interactive elements and respect `prefers-reduced-motion` using `@media` query, ensuring WCAG AA compliance across the entire theme.
